...
/**
 * Define Action Links to display on the plugins page
**/
...
function add_action_links ( $links ) {
 $mylinks = array(
 '<a href="' . admin_url( 'options-general.php?page=wp-hentry-fixer' ) . '">Settings</a>',
 );
   ...
   <div class="wrap">
     ...
     <form action="options.php" method="post">
       ...
       <table cellspacing="15px">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>No <code>hentry</code> class should be attached to the <code>body</code> element of the pages for the options selected above.</td>
            </tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>Search for <code>&lt;!-- WP Hentry Fixer --&gt;</code> in the page source to view injected data.</td>
            </tr>
            ...
            <?php
              ...
              if($available_post_types){
                ...
                echo '<tr>';
                echo '<td>&nbsp;</td>';
                echo '<td>Search for <code>&lt;!-- WP Hentry Fixer --&gt;</code> in the page source to view injected data.</td>';
                echo '</tr>';
              }
            ?>
